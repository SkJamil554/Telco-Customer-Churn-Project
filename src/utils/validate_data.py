...
def validate_telco_data(df) -> Tuple[bool, List[str]]:
    ...
    # === TYPE COERCION (fix known dirty-data issue) ===
    # TotalCharges arrives as an object column because ~11 rows contain " " (blank)
    # instead of a number, usually for customers with tenure == 0.
    ...
    # Total charges should mostly not be null (a few new customers with tenure=0 
    ge_df.expect_column_values_to_not_be_null("TotalCharges", mostly=0.99)
